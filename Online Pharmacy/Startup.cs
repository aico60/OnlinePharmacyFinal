...
using Online_Pharmacy.Controllers;
...
namespace Online_Pharmacy
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, UserManager<SiteUser> userManager, RoleManager<IdentityRole> roleManager)
        {
